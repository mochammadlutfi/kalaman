                    ...
                    <div class="row">
                        <div class="col-8">
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control {{ $errors->has('nama') ? 'is-invalid' : '' }}"
                                    id="field-nama" name="nama" placeholder="Masukan Nama Training" value="{{ old('nama') }}">
                                <x-input-error :messages="$errors->get('nama')" class="mt-2" />
                            </div>
                            <div class="mb-4">
                                <label for="field-lokasi">Lokasi</label>
                                <input type="text" class="form-control {{ $errors->has('lokasi') ? 'is-invalid' : '' }}"
                                    id="field-lokasi" name="lokasi" placeholder="Masukan Lokasi Training" value="{{ old('lokasi') ?? '' }}">
                        ...
                        <div class="col-4">
                            <div class="mb-4">
                                ...
                                <input type="number" name="slot" class="form-control  {{ $errors->has('slot') ? 'is-invalid' : '' }}" value="{{ old('slot') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control {{ $errors->has('tgl_daftar') ? 'is-invalid' : '' }}"
                                    id="field-tgl_daftar" name="tgl_daftar" placeholder="Masukan Tanggal Daftar" value="{{ old('tgl_daftar') ?? '' }}">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" class="form-control {{ $errors->has('tgl_training') ? 'is-invalid' : '' }}"
                                    id="field-tgl_training" name="tgl_training" placeholder="Masukan Tanggal Training" value="{{ old('tgl_training') ?? '' }}">
